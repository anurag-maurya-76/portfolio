...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative flex flex-col items-center  gap-y-32 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}
      >
